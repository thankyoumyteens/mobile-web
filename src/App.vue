<template>
  <div id="app" v-if="isMobile">
    ...
    <section id="viewer">
      <router-view
        :user="user"
        @success="loginSuccess" @detail="detail" @logout="logoutSuccess"
        @avatar="changeAvatarSuccess" @update="updateSuccess" @search="openSearch"
        @category="openProductions"/>
    </section>
    <section id="navBar">
      <div @click="goTo('home')"
           :class="[currentComponent === 'home' ? 'nav-active' : '']" class="nav-item">
        <i class="nav-item-icon iconfont icon-shouye"></i>
        <span class="nav-item-text">首页</span>
      </div>
      <div @click="goTo('category')"
           :class="[currentComponent === 'category' ? 'nav-active' : '']" class="nav-item">
        <i class="nav-item-icon iconfont icon-leimupinleifenleileibie"></i>
      ...
      <div @click="goTo('cart')"
           :class="[currentComponent === 'cart' ? 'nav-active' : '']" class="nav-item">
        <i class="nav-item-icon iconfont icon-gouwuche"></i>
        <span class="nav-item-text">购物车</span>
      </div>
      <div @click="goTo('user')"
           :class="[currentComponent === 'user' ? 'nav-active' : '']" class="nav-item">
        <i class="nav-item-icon iconfont icon-yonghu"></i>
